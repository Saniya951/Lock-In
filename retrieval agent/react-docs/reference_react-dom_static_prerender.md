...
#### Parameters 
  ...
  * **optional** `options`: An object with static generation options.
    ...
    * **optional** `signal`: An [abort signal](https://developer.mozilla.org/en-US/docs/Web/API/AbortSignal) that lets you abort prerendering and render the rest on the client.
