    ...
    <div className="h-screen bg-[#050505] text-white flex flex-col">
      ...
      <div className="border-b border-white/5 bg-[#050505]/80 backdrop-blur-lg px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          {currentSessionId && (
            <button onClick={() => setShowSyncModal(true)} className="flex items-center gap-2 px-4 py-2 bg-[#24292e] hover:bg-black border border-white/10 rounded-lg text-sm font-semibold transition-all">
