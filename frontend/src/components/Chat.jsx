            ...
            <div className="flex gap-2">
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 border rounded-lg text-sm font-semibold transition-all ${
                  isDarkMode
                    ? "bg-[#24292e] hover:bg-black border-white/10 text-white"
            ...
            <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm">
              ...
              >
                ...
                <textarea
                  ...
                  className={`w-full rounded-lg p-3 mb-6 focus:outline-none focus:border-indigo-500 h-24 resize-none text-sm transition-colors ${
                    isDarkMode
